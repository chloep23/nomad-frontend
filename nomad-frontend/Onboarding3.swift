        ...
        VStack(alignment: .leading) {
            ...
            VStack {
                ZStack(alignment: .leading) {
                    if onboardingViewModel.dateOfBirth.isEmpty {
                        Text("mm/dd/yyyy")
                            .font(.system(size: 15))
                    ...
                    TextField("", text: $onboardingViewModel.dateOfBirth)
            ...
            Button(action: {
                ...
                .background(onboardingViewModel.validateStep3() ? Color(red: 4/255, green: 57/255, blue: 11/255) : Color.gray)
                .cornerRadius(30)
                .shadow(color: .black.opacity(0.3), radius: 2, x: 3, y: 5)
            }
            .disabled(!onboardingViewModel.validateStep3())
            .offset(x: 180, y: -20)
